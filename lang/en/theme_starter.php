...
$string['choosereadme'] = 'Theme Starter is a child theme of Boost. It adds the ability to upload background photos.';
// Name of the settings pages.
$string['configtitle'] = 'Starter settings';
